...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen bg-slate-50 text-slate-900 overflow-hidden">
      ...
      {/* ── SIDEBAR ── */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-60 bg-white border-r border-slate-100 flex flex-col transform transition-transform duration-300 ease-in-out md:relative md:translate-x-0 ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"}`}>
