...
export default function FinTraAuth() {
        ...
        <Card className="flex-1 rounded-none border-0 border-r flex flex-col justify-center">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
              <Label>Email</Label>
              <Input type="email" placeholder="you@fintra.io" />
            </div>
            <div className="space-y-1.5">
            ...
            <p className="text-center text-xs text-slate-400">
              Chưa có tài khoản?{" "}
              <span onClick={() => setMode("login")} className="text-blue-600 cursor-pointer hover:underline font-medium">
                Đăng ký
              </span>
            </p>
          </CardContent>
        ...
        <Card className="flex-1 rounded-none border-0 flex flex-col justify-center">
          ...
          <CardContent className="space-y-3">
            <div className="space-y-1.5">
              ...
              <Input type="text" placeholder="Xuân Thưởng" />
            </div>
            <div className="space-y-1.5">
              <Label>Email</Label>
            ...
            <p className="text-center text-xs text-slate-400">
              Đã có tài khoản?{" "}
              <span onClick={() => setMode("register")} className="text-blue-600 cursor-pointer hover:underline font-medium">
                Đăng nhập
              </span>
            </p>
          </CardContent>
